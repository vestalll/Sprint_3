...
public class CreateCourierTest {
 ...
 //  assertThat("Courier ID is incorrect", responseText, is("ok"));
    ...
    public void courierCreationWithoutLogin() {
        ...
        assertThat( "Invalid status code", statusCode, equalTo(SC_BAD_REQUEST));
    ...
    public void courierCreationWithExistedCredentials() {
        ...
        assertThat( "Invalid status code", statusCode, equalTo(SC_CONFLICT));
        assertThat("Invalid message text", messageText, equalTo("Этот логин уже используется. Попробуйте другой."));
    }
